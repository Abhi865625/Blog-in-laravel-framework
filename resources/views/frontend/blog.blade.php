...
@section('main-container')
    ...
    <section class="section section-bg" id="call-to-action"
        style="background-image: url({{url('frontend/images/banner-image-1-1920x500.jpg')}})">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <ul>
                        <li>
                            <p><a href="{{url('/blog-details')}}">Artificial Intelligence: The Future of Innovation</a></p>
                        ...
                        <li>
                            <p><a href="{{url('/blog-details')}}">Revolutionizing Digital Marketing: The Power of Artificial
                                    Intelligence</a></p>
                            <small><i class="fa fa-user"></i> Abhishek Mehta &nbsp;|&nbsp; <i
                                    class="fa fa-calendar"></i>
                        ...
                        <li>
                            <p><a href="{{url('/blog-details')}}">Advantages and Disadvantages of AI
