...
<?php $__env->startSection('main-container'); ?>
    ...
    <div class="main-banner" id="top">
        <video autoplay muted loop id="bg-video">
            <source src="<?php echo e(url('frontend/images/video.mp4')); ?>" type="video/mp4" />
        </video>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <img src="<?php echo e(url('frontend/images/line-dec.png')); ?>" alt="">
            ...
            <div class="row" id="tabs">
                <div class="col-lg-4">
                    <ul>
                        ...
                        <div class="main-rounded-button"><a href="<?php echo e(url('/blog')); ?>">Read More</a></div>
                    </ul>
                </div>
                <div class="col-lg-8">
    ...
    <section class="section section-bg" id="schedule"
        style="background-image: url(<?php echo e(url('frontend/images/about-fullscreen-1-1920x700.jpg')); ?>)">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\demo-app\resources\views/frontend/index.blade.php ENDPATH**/ ?>