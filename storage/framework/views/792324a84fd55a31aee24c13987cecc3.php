            ...
            <div class="row" id="tabs">
              ...
              <div class="col-lg-8">
                <section class='tabs-content'>
                  <article id='tabs-1'>
                    <img src="<?php echo e(url('frontend/images/about-image-1-940x460.jpg')); ?>" alt="">
                    <h4>Our Goals</h4>
                  ...
                  <article id='tabs-2'>
                    <img src="<?php echo e(url('frontend/images/about-image-2-940x460.jpg')); ?>" alt="">
                    <h4>Our Work</h4>
                  ...
                  <article id='tabs-3'>
                    <img src="<?php echo e(url('frontend/images/about-image-3-940x460.jpg')); ?>" alt="">
                    <h4>Our Passion</h4>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\demo-app\resources\views/frontend/about.blade.php ENDPATH**/ ?>